...
extension Sequence where Self.Iterator.Element: Convertible, Self.Iterator.Element.ConvertedType == Self.Iterator.Element {
...
extension Sequence where Self.Iterator.Element: Sequence,
    ...
    public typealias ResultingType = Self.Iterator.Element.Iterator.Element.ConvertedType
